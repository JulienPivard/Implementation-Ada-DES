...
package body Des_P.Filtre_P.Fabrique_P.Cryptage_P is
   ...
   is
      ...
      Filtre : Des_P.Filtre_P.Entree_P.Cryptage_P.Entree_T;
   begin
      return Filtre;
   ...
   is
      pragma Unreferenced (Fabrique);
      Filtre : Des_P.Filtre_P.Corps_P.Cryptage_P.Corps_T;
   begin
   ...
   is
      pragma Unreferenced (Fabrique);
      Filtre : Des_P.Filtre_P.Sortie_P.Cryptage_P.Sortie_T;
   begin
      return Filtre;
