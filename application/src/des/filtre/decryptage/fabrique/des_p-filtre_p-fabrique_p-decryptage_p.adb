...
package body Des_P.Filtre_P.Fabrique_P.Decryptage_P is
   ...
   is
      ...
      Filtre : Des_P.Filtre_P.Entree_P.Decryptage_P.Entree_T;
   begin
      return Filtre;
   ...
   is
      pragma Unreferenced (Fabrique);
      Filtre : Des_P.Filtre_P.Corps_P.Decryptage_P.Corps_T;
   begin
   ...
   is
      pragma Unreferenced (Fabrique);
      Filtre : Des_P.Filtre_P.Sortie_P.Decryptage_P.Sortie_T;
   begin
      return Filtre;
   end Fabriquer_Sortie;

end Des_P.Filtre_P.Fabrique_P.Decryptage_P;
