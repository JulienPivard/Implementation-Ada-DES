...
package body Gerer_Options_P is
   ...
   begin
      ...
      if Taille_Clef /= 64 then
         ...
         Ada.Text_IO.Put
            (
               Ada.Text_IO.Standard_Error,
               "   Taille actuelle de la clef : "
            );
         Ada.Text_IO.Put (Ada.Text_IO.Standard_Error, Taille_Clef'Img);
         Ada.Text_IO.Put_Line (Ada.Text_IO.Standard_Error, " octets.");
   ...
   is
      ...
      Nom_Fichier : constant String :=
         Ada.Command_Line.Argument (Position_Nom_Fic);
   begin
