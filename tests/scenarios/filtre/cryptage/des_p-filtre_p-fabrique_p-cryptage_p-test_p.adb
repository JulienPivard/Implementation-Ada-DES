...
package body Des_P.Filtre_P.Fabrique_P.Cryptage_P.Test_P is
   ...
   is
      use Des_P.Filtre_P.Entree_P.Cryptage_P;
      Entree : Entree_T;
   begin
   ...
   procedure Test_Fabrication_Sortie
      (T : in out Test_Fixt_T)
   is
      use Des_P.Filtre_P.Sortie_P.Cryptage_P;
      Sortie : Sortie_T;
   begin
      AUnit.Assertions.Assert
...
end Des_P.Filtre_P.Fabrique_P.Cryptage_P.Test_P;
