...
package body Des_P.Filtre_P.Fabrique_P.Chiffre_P.Test_P is
   ...
   is
      package Entree_R renames Des_P.Filtre_P.Entree_P.Chiffre_P;
   ...
   procedure Test_Fabrication_Corps
      (T : in out Test_Fixt_T)
   is
      package Corps_R renames Des_P.Filtre_P.Corps_P.Chiffre_P;
   ...
   procedure Test_Fabrication_Sortie
      (T : in out Test_Fixt_T)
   is
      package Sortie_R renames Des_P.Filtre_P.Sortie_P.Chiffre_P;
...
end Des_P.Filtre_P.Fabrique_P.Chiffre_P.Test_P;
