...
package body Des_P.Bloc_P.Bloc_64_P.Constructeur_P.Test_P is
   ...
   begin
      c.Preparer_Nouveau_Bloc_64 (brut_attendu);
      T.constructeur := c;
   end Set_Up;
   ...
   begin
      AUnit.Assertions.Assert
         ...
         "Le brut de 64 bits ne vaut pas la bonne valeur."
         );
   ...
   begin
      ...
      AUnit.Assertions.Assert
         (T.constructeur.Brut = brut_attendu,
         "Le brut de 64 bits a été modifié durant la construction."
         );
      for I in Intervalle_Bloc_64_T'Range loop
         AUnit.Assertions.Assert
   ...
   begin
      ...
      bloc_resultat := T.constructeur.Recuperer_Bloc_64;
      for I in Intervalle_Bloc_64_T'Range loop
         AUnit.Assertions.Assert
