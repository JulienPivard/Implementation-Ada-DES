...
with Ip_Decryptage_Suite_P;
with Op_Decryptage_Suite_P;
...
package body Suite_De_Tests_Filtre_P is
   ...
   begin
      ...
      ptr_test_suite.all.Add_Test (Ip_Decryptage_Suite_P.Fonc_Suite);
      ptr_test_suite.all.Add_Test (Op_Decryptage_Suite_P.Fonc_Suite);
