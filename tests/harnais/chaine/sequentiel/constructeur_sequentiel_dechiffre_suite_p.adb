...
with Des_P.Chaine_P.Sequentiel_P.Constructeur_Dechiffre_P.Test_P;
use  Des_P.Chaine_P.Sequentiel_P.Constructeur_Dechiffre_P.Test_P;
...
end Constructeur_Sequentiel_Dechiffre_Suite_P;
