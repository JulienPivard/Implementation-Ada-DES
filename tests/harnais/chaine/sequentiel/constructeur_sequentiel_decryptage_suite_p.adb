...
with Des_P.Chaine_P.Sequentiel_P.Constructeur_Decryptage_P.Test_P;
use  Des_P.Chaine_P.Sequentiel_P.Constructeur_Decryptage_P.Test_P;

package body Constructeur_Sequentiel_Decryptage_Suite_P is
...
end Constructeur_Sequentiel_Decryptage_Suite_P;
